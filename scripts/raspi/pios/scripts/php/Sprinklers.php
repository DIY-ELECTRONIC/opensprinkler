...
$newSprinklerValveSettings=file_get_contents('http://192.168.1.55/sn0');
...
echo "<table><caption><font size=5><b>Irrigation Events Date/Time <br/>(last $timeViewWindow)</b></font></caption>";
...
// For debugging
//file_put_contents ("/var/www/irrlog/SprinklerSchedule.txt", $schedule."\n\nSchedule Extracted\n".$schedulex."\n\n Status=\n".$status."\n\n Statusx=\n".$statusx."\n\nResult:".$schedulex."\n".$statusx."\nvar simdate = new Date($year,$monthm1,$day,0,0,0); // Java Date object, assumes month starts from 0\nvar simday = (simdate.getTime()/1000/3600/24)>>0;\n");
?>
<script>
