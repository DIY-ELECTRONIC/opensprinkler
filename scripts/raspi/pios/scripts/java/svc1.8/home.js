...
function imgstr(s) {return "<img src=\"http://192.168.1.50/images/icons/svc_"+s+".png\" height=20 align=absmiddle>&nbsp;";}
...
w("<button style=\"height:44\" onclick=link(\"/vs\")>"+imgstr("edit")+"Zones</button>");
w("<button style=\"height:44\" onclick=link(\"/vp\")>"+imgstr("cal")+"Programs</button>");
w("<button style=\"height:44\" onclick=linkn(\"http://192.168.1.50/scripts/php/Sprinklers.php\")>"+imgstr("log")+"Logger</button><p></p>");
...
w("<script type=\"text/javascript\" src=\"http://192.168.1.50/scripts/java/svc1.8/"+((mm)?"manualmode.js":"progmode.js")+"\"></script>");
